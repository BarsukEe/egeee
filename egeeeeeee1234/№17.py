...
for i in range(len(a)-2):
    #а вот тут мы уже рассматриваем "компании" чисел. Если нам нужно работать с парами - вписываем range(len(a)-1), если с тройками, как например здесь - range(len(a)-2). Обращаться к нашим числам мы тоже будем по другому. a[i] - первые элемент тройки, a[i+1] - второй элемент тройки, a[i+2] - третий. Представим, что нам нужно найти количество троек, в которой два числа из трёх - четырёхзначные, и их произведение больше нашего максимального трёхзначного элемента последовательности (переменная maks).
